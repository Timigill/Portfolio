    ...
    >
      <div className="container">
        ...
        >
          ...
          {/* Email Icon */}
          <a
            href="mailto:taimoorgill153@gmail.com"
            style={{
              color: "#f0f0f0",
              fontSize: "1.5rem",
              textDecoration: "none",
          ...
          {/* LinkedIn Icon */}
          <a
            href="https://www.linkedin.com/in/taimoor-ishaq-59125235b/"
            target="_blank"
          ...
          {/* GitHub Icon */}
          <a
            href="https://github.com/Timigill"
            target="_blank"
            rel="noopener noreferrer"
            style={{
              color: "#f0f0f0",
        ...
        >
          Copyright ©2025 <a href="#" style={{ color: "#00BFFF", textDecoration: "none" }}>Taimoor Gill</a>
        </p>
      </div>
    </footer>
  );
